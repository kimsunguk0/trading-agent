"""KIS domestic KR mock adapter with rate limiting and websocket stream support."""
...
from brokers.capabilities import KIS_KR_MOCK_CAPS
...
class KISDomesticKrMockAdapter:
    name: str = "kis_domestic_kr_mock"
    capabilities: BrokerCapabilities = KIS_KR_MOCK_CAPS
